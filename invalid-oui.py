...
data_str = "this is a frame with invalid oui\x00"
...
packet = RadioTap() \
    / Dot11FCS(
        ...
        addr3=BROADCAST_MAC,
        FCfield=0) \
    / Dot11VendorSpecificActionFrameESP(oui=0x123456) \
    / Dot11VendorSpecificIEESP(oui=0x123456, len=data_len, data=data_str)
packet.show()
